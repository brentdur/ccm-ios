...
static const CGFloat CSToastLowerPadding        = 50.0;
...
NSString * const CSToastPositionLower           = @"lower";
...
- (CGPoint)centerPointForPosition:(id)point withToast:(UIView *)toast {
    if([point isKindOfClass:[NSString class]]) {
        ...
        else if ([point caseInsensitiveCompare:CSToastPositionLower] == NSOrderedSame) {
            return CGPointMake(self.bounds.size.width/2, (self.bounds.size.height - (toast.frame.size.height / 2) - CSToastLowerPadding) - CSToastVerticalPadding);
        }
